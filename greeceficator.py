...
def greeceficator_all_langs(text: str):
    ...
    # Replace '?' at the end of a sentence or followed by whitespace with ';'
...
if __name__ == '__main__':
    ...
    print(greeceficator_all_langs('Hi, how are you Sergios? Everything is fine, thanks Theodoros!'))
